...
# Load model
cnn_model = tf.keras.models.load_model("vehicle.h5")        
...
def classify(model, image_path):
    ...
    label = "Audi" if prob[0][0] >= 0.5  else "Lamborgini"
...
def upload_file():
    ...
    return render_template(
        "classify123.html", image_file_name=file.filename, label=label, prob=prob) 
